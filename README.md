...
configuration. Its [v0.5.19 compatibility matrix](https://github.com/mikolaj92/app-factory/blob/v0.5.19/COMPAT.md)
still lists my-auth `v0.3.23`; this package remains at the newer `v0.3.24`
rather than regressing release metadata. The published `fastapi-htmx` extra
accepts `app-factory>=0.5`.
